...
func (m *NinRepNative) MarshalTo(data []byte) (int, error) {
	...
	if len(m.Field3) > 0 {
		for _, num := range m.Field3 {
			data[i] = 0x18
			i++
			i = encodeVarintFuzz(data, i, uint64(num))
		}
	}
	if len(m.Field4) > 0 {
	...
	if len(m.Field15) > 0 {
		for _, b := range m.Field15 {
			data[i] = 0x7a
			i++
			i = encodeVarintFuzz(data, i, uint64(len(b)))
			i += copy(data[i:], b)
		}
	}
	if m.XXX_unrecognized != nil {
...
func (m *NinRepPackedNative) MarshalTo(data []byte) (int, error) {
	...
	if len(m.Field7) > 0 {
		...
		data[i] = 0x3a
		i++
		i = encodeVarintFuzz(data, i, uint64(j16))
	...
	if len(m.Field8) > 0 {
		...
		data[i] = 0x42
		i++
		i = encodeVarintFuzz(data, i, uint64(j18))
...
func (m *NinRepStruct) MarshalTo(data []byte) (int, error) {
	...
	if len(m.Field3) > 0 {
		for _, msg := range m.Field3 {
			data[i] = 0x1a
			i++
			i = encodeVarintFuzz(data, i, uint64(msg.Size()))
...
func (m *NinNestedStruct) MarshalTo(data []byte) (int, error) {
	...
	if m.Field1 != nil {
		data[i] = 0xa
		i++
		i = encodeVarintFuzz(data, i, uint64(m.Field1.Size()))
...
func (m *NinOptEnum) MarshalTo(data []byte) (int, error) {
	...
	if m.Field1 != nil {
		data[i] = 0x8
		i++
		i = encodeVarintFuzz(data, i, uint64(*m.Field1))
	}
	if m.XXX_unrecognized != nil {
		i += copy(data[i:], m.XXX_unrecognized)
	}
...
func (m *OtherExtenable) MarshalTo(data []byte) (int, error) {
	...
	if m.M != nil {
		data[i] = 0xa
		i++
		i = encodeVarintFuzz(data, i, uint64(m.M.Size()))
	...
	if m.Field2 != nil {
		data[i] = 0x10
		i++
		i = encodeVarintFuzz(data, i, uint64(*m.Field2))
	}
	if m.Field13 != nil {
		data[i] = 0x68
		i++
		i = encodeVarintFuzz(data, i, uint64(*m.Field13))
	}
	if len(m.XXX_extensions) > 0 {
		n, err := github_com_gogo_protobuf_proto.EncodeExtensionMap(m.XXX_extensions, data[i:])
		if err != nil {
...
func (m *NestedDefinition) MarshalTo(data []byte) (int, error) {
	...
	if m.EnumField != nil {
		data[i] = 0x10
		i++
		i = encodeVarintFuzz(data, i, uint64(*m.EnumField))
	}
	if m.NNM != nil {
		data[i] = 0x1a
		i++
		i = encodeVarintFuzz(data, i, uint64(m.NNM.Size()))
	...
	if m.NM != nil {
		data[i] = 0x22
		i++
		i = encodeVarintFuzz(data, i, uint64(m.NM.Size()))
...
func (m *NestedDefinition_NestedMessage) MarshalTo(data []byte) (int, error) {
	...
	if m.NestedField1 != nil {
		data[i] = 0x9
		i++
		i = encodeFixed64Fuzz(data, i, uint64(*m.NestedField1))
	}
	if m.NNM != nil {
		data[i] = 0x12
		i++
...
func (m *NestedDefinition_NestedMessage_NestedNestedMsg) MarshalTo(data []byte) (int, error) {
	...
	if m.NestedNestedField1 != nil {
		data[i] = 0x52
		i++
		i = encodeVarintFuzz(data, i, uint64(len(*m.NestedNestedField1)))
...
func (m *NestedScope) MarshalTo(data []byte) (int, error) {
	...
	if m.A != nil {
		data[i] = 0xa
		i++
		i = encodeVarintFuzz(data, i, uint64(m.A.Size()))
	...
	if m.B != nil {
		data[i] = 0x10
		i++
		i = encodeVarintFuzz(data, i, uint64(*m.B))
	}
	if m.C != nil {
		data[i] = 0x1a
		i++
		i = encodeVarintFuzz(data, i, uint64(m.C.Size()))
...
func (m *OtherExtenable) Size() (n int) {
	...
	if m.Field2 != nil {
		n += 1 + sovFuzz(uint64(*m.Field2))
	}
	if m.Field13 != nil {
		n += 1 + sovFuzz(uint64(*m.Field13))
	}
	if m.XXX_extensions != nil {
		n += github_com_gogo_protobuf_proto.SizeOfExtensionMap(m.XXX_extensions)
	}
...
func (m *NestedDefinition) Size() (n int) {
	...
	if m.EnumField != nil {
		n += 1 + sovFuzz(uint64(*m.EnumField))
	}
	if m.NNM != nil {
		l = m.NNM.Size()
		n += 1 + l + sovFuzz(uint64(l))
